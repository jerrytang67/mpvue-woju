<template>
  <div class="container">
    ...
    <van-cell-group>
      ...
      <van-card v-for="x in cartItems" 
      lazy-load="true" :key="x" :tag="x.BuyItem.Type" :desc="x.BuyItem.ShareDesc" :title="x.BuyItem.Name" :thumb="x.BuyItem.LogoList[0]+'!w100h100'" :num="x.Count" :origin-price="x.BuyItem.Price" :price="x.BuyItem.VipPrice" >
          <view slot="footer">
        ...
        <van-submit-bar :disabled="totalVipPrice<=0"  :price="totalVipPrice*100"  button-text="提交订单" bind:submit="onSubmit">
